...
class ArticleModel extends Model
{
    ...
    {
        return $this->field('flow_article.*,cate_name')->join('flow_article_cate', 'flow_article.cate_id = flow_article_cate.id')->where($map)->limit($Nowpage,$limits)->order('id desc')->select();
